  ...
  return (
    <div className="flex flex-col h-screen bg-background">
      ...
      <div className="px-8 py-4 border-b border-outline-variant/65 bg-white sticky top-0 z-20 flex justify-between items-center">
        <div>
          <div className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">Talk to Your Data</div>
          <h1 className="text-3xl font-serif font-medium text-primary mt-0.5 tracking-tight">Ask anything about your expenses</h1>
        </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {mode === "text" && (
          <>
            {/* LEFT PANEL */}
            <div className="w-[340px] shrink-0 border-r border-outline-variant/50 bg-white flex flex-col h-full">
              ...
              <div className="p-5 border-t border-outline-variant/40 bg-white">
                <div className={`rounded-2xl border bg-white shadow-sm transition-all ${loading ? "ai-glow border-secondary/30" : "border-outline-variant/60"}`}>
                  <div className="flex items-start gap-2 px-4 py-5">
                    <span className="text-secondary text-sm font-bold mt-0.5">✦</span>
                    <textarea
                      value={question}
            ...
            <div className="flex-1 min-w-0 overflow-y-auto overflow-x-hidden p-8">
              ...
              {!result && !loading && !error && (
                <div className="flex flex-col items-center justify-center h-full min-h-[400px] text-center">
                  ...
                  <p className="text-sm text-on-surface-variant mt-2 max-w-sm">Ask about spend, violations, employees, or fraud patterns.</p>
                </div>
              )}
